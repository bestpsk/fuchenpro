<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="jobLogList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="日志编号" min-width="80" align="center" prop="jobLogId" />
         ...
         <el-table-column label="执行时间" align="center" prop="createTime" min-width="180">
            <template #default="scope">
         ...
         <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               <el-button link type="primary" icon="View" @click="handleView(scope.row)" v-hasPermi="['monitor:jobLog:list']">详细</el-button>
            </template>
         </el-table-column>
      </el-table>
